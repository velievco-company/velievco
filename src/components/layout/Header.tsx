              ...
              className={`font-playfair text-xs tracking-[0.15em] uppercase transition-colors duration-300 relative
                ...
                ${
                  location.pathname === link.path
                    ? "text-primary after:bg-brown after:scale-x-100 after:origin-left"
                    : "text-foreground/70 hover:text-brown after:bg-brown"
                }`}
            >
              {link.name}
            </Link>
        ...
        <div className="bg-background/98 backdrop-blur-md border-t border-border px-6 py-8 flex flex-col gap-6">
          {navLinks.map((link) => (
            <Link
              key={link.path}
              to={link.path}
              className={`font-playfair text-lg tracking-wider uppercase transition-colors duration-300 hover:text-brown ${
                location.pathname === link.path
                  ? "text-primary"
                  : "text-foreground/70"
              }`}
