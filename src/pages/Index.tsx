  ...
  return <>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <ScrollReveal>
          <div className="text-center mb-20">
            <p className="font-playfair text-sm uppercase tracking-[0.3em] text-primary mb-4">Our Commitment</p>
            <h2 className="font-cormorant text-4xl md:text-5xl font-light text-foreground">Built on Three Pillars</h2>
          </div>
        </ScrollReveal>
    ...
    <section className="py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <ScrollReveal>
          <div className="text-center mb-20">
            <p className="font-playfair text-sm uppercase tracking-[0.3em] text-primary mb-4">Our Process</p>
